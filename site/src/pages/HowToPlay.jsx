    ...
    <div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4">
        ...
        <div className="mb-20" id="passes">
          <p className="section-subtitle mb-4">{t.pages.bundles.hero.sub}</p>
          <h2 className="text-3xl font-black text-white mb-3">{t.pages.bundles.hero.title}</h2>
          <p className="text-white/50 text-sm mb-10">{t.pages.bundles.hero.desc}</p>
